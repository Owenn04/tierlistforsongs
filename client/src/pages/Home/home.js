...
import "./home.css"
import Controls from '../../components/Controls/controls.js'```javascript
...
const Home = () => {
    ...
    useEffect(() => {
        if (selectedRow >= boxItems.length) {
            setSelectedRow(boxItems.length - 1);
        }
        if (selectedBox >= boxItems[selectedRow].length) {
            setSelectedBox(boxItems[selectedRow].length - 1);
        }
    }, [boxItems, selectedRow, selectedBox]);
            ...
            <div className="box">
                <div className="inner-box1">
                    <Controls 
                        ...
                        onPlusSelect={handleNewRow} 
                        onMinusSelect={handleCellRowRemoval}
                    />
                </div>
